...
@CucumberOptions(
        features = "src/test/resources/features/publisher/openid_token.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/openid-token.html"}
)
...
public class OpenIDTokenRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        OpenIDTokenRunner runner = new OpenIDTokenRunner();
