...
@CucumberOptions(
        features = "src/test/resources/features/publisher/revoke_token.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/revoke-token.html"}
)
...
public class RevokeTokenRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        RevokeTokenRunner runner = new RevokeTokenRunner();
