...
@CucumberOptions(
        features = "src/test/resources/features/publisher/jwt_token_format.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/jwt-token-format.html"}
)
...
public class JWTTokenFormatRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        JWTTokenFormatRunner runner = new JWTTokenFormatRunner();
