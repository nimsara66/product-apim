...
@CucumberOptions(
        features = "src/test/resources/features/publisher/graphql_api_baseline.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/graphql-api-baseline.html"}
)
...
public class GraphQLApiBaselineRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        GraphQLApiBaselineRunner runner = new GraphQLApiBaselineRunner();
