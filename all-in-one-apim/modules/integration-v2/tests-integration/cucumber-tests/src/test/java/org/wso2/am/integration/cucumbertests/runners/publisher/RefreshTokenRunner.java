...
@CucumberOptions(
        features = "src/test/resources/features/publisher/refresh_token.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/refresh-token.html"}
)
...
public class RefreshTokenRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        RefreshTokenRunner runner = new RefreshTokenRunner();
