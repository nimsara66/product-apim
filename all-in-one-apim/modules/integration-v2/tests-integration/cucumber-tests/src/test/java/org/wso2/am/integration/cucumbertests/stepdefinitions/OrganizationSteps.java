...
public class OrganizationSteps {
    ...
    public void iCreateOrganization(String externalOrgId, String displayName, String idKey) throws IOException {
        ...
        TestContext.remove("httpResponse");
        HttpResponse response = SimpleHTTPClient.getInstance().doPost(Utils.getOrganizationsURL(getBaseUrl()),
        ...
        TestContext.set(idKey, Utils.extractValueFromPayload(response.getData(), "organizationId"));
    ...
    public void iRetrieveAllOrganizations() throws IOException {
        ...
        HttpResponse response = SimpleHTTPClient.getInstance()
                .doGet(Utils.getOrganizationsURL(getBaseUrl()), adminAuthHeaders());
        TestContext.set("httpResponse", response);
    }
    ...
    public void iDeleteOrganization(String idKey) throws IOException {
        ...
        String orgId = Utils.resolveFromContext(idKey).toString();
        TestContext.remove("httpResponse");
        HttpResponse response = SimpleHTTPClient.getInstance()
                .doDelete(Utils.getOrganizationByIdURL(getBaseUrl(), orgId), adminAuthHeaders());
        TestContext.set("httpResponse", response);
    }
    ...
    public void iRetrieveDevportalApiAnonymously(String apiIdKey) throws IOException {
        ...
        TestContext.remove("httpResponse");
        HttpResponse response = SimpleHTTPClient.getInstance()
                .doGet(Utils.getDevportalApiDetailURL(getBaseUrl(), apiId), new HashMap<>());
        TestContext.set("httpResponse", response);
    }
    ...
    public void iDevportalKeyManagersUntilContains(String idKey, int timeoutSeconds) throws InterruptedException {
        pollDevportalKeyManagers(Utils.resolveFromContext(idKey).toString(), true, timeoutSeconds);
    }
    ...
    public void iDevportalKeyManagersUntilAbsent(String idKey, int timeoutSeconds) throws InterruptedException {
        pollDevportalKeyManagers(Utils.resolveFromContext(idKey).toString(), false, timeoutSeconds);
    }
