...
@CucumberOptions(
        features = "src/test/resources/features/publisher/subscription_throttling_policy.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/subscription-throttling-policy.html"}
)
...
public class SubscriptionThrottlingPolicyRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        SubscriptionThrottlingPolicyRunner runner = new SubscriptionThrottlingPolicyRunner();
