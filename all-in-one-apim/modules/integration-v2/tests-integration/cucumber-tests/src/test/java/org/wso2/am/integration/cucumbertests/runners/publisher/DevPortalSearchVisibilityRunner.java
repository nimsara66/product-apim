...
@CucumberOptions(
        features = "src/test/resources/features/publisher/devportal_search_visibility.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/devportal-search-visibility.html"}
)
...
public class DevPortalSearchVisibilityRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        DevPortalSearchVisibilityRunner runner = new DevPortalSearchVisibilityRunner();
