...
@CucumberOptions(
        features = "src/test/resources/features/publisher/governance_policy_baseline.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/governance-policy-baseline.html"}
)
...
public class GovernancePolicyBaselineRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        GovernancePolicyBaselineRunner runner = new GovernancePolicyBaselineRunner();
