...
@CucumberOptions(
        features = "src/test/resources/features/publisher/websocket_api_baseline.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/websocket-api-baseline.html"}
)
...
public class WebSocketApiBaselineRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        WebSocketApiBaselineRunner runner = new WebSocketApiBaselineRunner();
