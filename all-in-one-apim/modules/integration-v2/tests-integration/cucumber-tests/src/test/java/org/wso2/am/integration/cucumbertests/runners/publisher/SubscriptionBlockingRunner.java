...
@CucumberOptions(
        features = "src/test/resources/features/publisher/subscription_blocking.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/subscription-blocking.html"}
)
...
public class SubscriptionBlockingRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        SubscriptionBlockingRunner runner = new SubscriptionBlockingRunner();
