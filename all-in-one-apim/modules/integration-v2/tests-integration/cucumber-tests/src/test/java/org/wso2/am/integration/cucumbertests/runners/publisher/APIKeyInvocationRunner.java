...
@CucumberOptions(
        features = "src/test/resources/features/publisher/api_key_invocation.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/api-key-invocation.html"}
)
...
public class APIKeyInvocationRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        APIKeyInvocationRunner runner = new APIKeyInvocationRunner();
