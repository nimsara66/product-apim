...
@CucumberOptions(
        features = "src/test/resources/features/publisher/sandbox_token.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/sandbox-token.html"}
)
...
public class SandboxTokenRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        SandboxTokenRunner runner = new SandboxTokenRunner();
