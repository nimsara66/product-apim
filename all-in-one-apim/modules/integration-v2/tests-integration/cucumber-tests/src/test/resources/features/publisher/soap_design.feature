...
Feature: Publisher SOAP API Design
  ...
  # SOAP-type API. Ports WSDLImportTestCase (file import). WSDL comes from the node-soap harness.
  ...
  # SoapToRestTestCase (create side). Uses the node-soap harness WSDL.
