...
**Status:** Design (approved decisions below). No code written yet.
...
**Prior art:** modelled on the api-platform (Go) coverage pipeline — see `api-platform-go-coverage-study.md`. This doc adapts that shape to Java/JVM + JaCoCo.
